...
|---|---|---|---|---|
| ReAct | 2210.03629 | ICLR 2023 | Foundational LLM Agent work | [ReAct_agent_report_en.md](./examples/ReAct_agent_report_en.md) |
| Vision Transformer (ViT) | 2010.11929 | ICLR 2021 | 70,000+ citations | [ViT_report_en.md](./examples/ViT_report_en.md) |
| Gated Attention | 2505.06708 | NeurIPS 2025 (Best Paper) | Best Paper Award | [Gated_Attention_report_en.md](./examples/Gated_Attention_report_en.md) |
| QLoRA | 2305.14314 | NeurIPS 2023 | 10,000+ citations | [QLoRA_report_en.md](./examples/QLoRA_report_en.md) |
...
├── LICENSE
├── examples/
│   ├── ReAct_agent_report_en.md
│   ├── ViT_report_en.md
│   ├── Gated_Attention_report_en.md
│   └── QLoRA_report_en.md
└── skills/
    └── paper-compass/
        ├── SKILL.md
